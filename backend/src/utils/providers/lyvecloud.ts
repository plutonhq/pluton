...
const lyvecloudSettings = [
...

	{
		...
		default: '',
		description:
			"Select a Region to connect to that region's API Endpoint. Custom Endpoint example: s3.us-central-2.lyvecloud.seagate.com",
		command: '--s3-endpoint',
	},
	{
		label: 'Bucket Name',
		...
		required: true,
		default: '',
		description: 'Your Lyve Cloud Bucket Name. eg: pluton-backup',
		command: '',
	},
	...s3Options,
];
