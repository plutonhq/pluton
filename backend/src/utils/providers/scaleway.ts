...
const scalewaySettings = [
	...
	},
	{
		...
		required: true,
		default: '',
		description: 'Your Scaleway Bucket Name. eg: pluton-backup',
		command: '',
	},
	{
		label: 'Endpoint',
		...
		default: '',
		description:
			"Select a Region to connect to that region's API Endpoint. Custom Endpoint example: my-bucket.s3.nl-ams.scw.cloud",
		command: '--s3-endpoint',
	},
	{
		label: 'ACL',
